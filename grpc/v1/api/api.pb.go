...
// v1 package needs to be updated.
const _ = proto.ProtoPackageIsVersion3 // please upgrade the v1 package
...
func init() { proto.RegisterFile("api.v1", fileDescriptor_00212fb1f9d3bf1c) }
